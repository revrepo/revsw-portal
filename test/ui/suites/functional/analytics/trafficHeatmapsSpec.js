  ...
  describe('Traffic Heatmaps', function () {
    ...
    it('should create a Hits Heatmap report with default values',
      function () {
        ...
        Portal.trafficHeatmapsPage.createGlobalTrafficHeatmaps(dataReport);
        
        var hitsHeatmapImg = Portal.trafficHeatmapsPage.form.existHitsHeatmap();
        //var gbtHeatmapImg = Portal.trafficHeatmapsPage.form.existGBTHeatMap();
        var getData = Portal.trafficHeatmapsPage.getInfoGlobalTrafficHeatmaps();
