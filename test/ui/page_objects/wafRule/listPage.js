...
var WAFList = {
  ...
  /**
   * ### WAFList.getAddNewCustomWAFRuleBtn()
   *
   ...
   * @returns {Object} Selenium WebDriver Element
   */
  getAddNewCustomWAFRuleBtn: function () {
    return element(
      by.partialLinkText(this.locators.buttons.addNewCustomWAFRule.linkText));
  },
  /**
  ...
  /**
   * ### WAFList.clickAddNewCustomWAFRule()
   *
   * Triggers a click to the `Add New Custom WAF Rule` button from the WAF Rule
   * page from the Portal app
   *
   * @returns {Object} Promise
   */
  clickAddNewCustomWAFRule: function () {
    return this
      .getAddNewCustomWAFRuleBtn()
      .click();
  },
  /**
