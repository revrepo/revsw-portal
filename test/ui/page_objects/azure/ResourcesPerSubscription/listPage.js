...
var ResourcesTable = require('./table/table');
...
var ResourcesPerSub = {
  ...
  getSearchTxtIn: function () {
    return element(by.css(this.locators.views.searchInputField));
  },

  getSearchComboBox: function () {
    return element(by.css(this.locators.views.searchComboBox));
  },
...
module.exports = ResourcesPerSub;
