...
var EdgeCacheForm = {
  ...
  locators: {
    reports: {
      ...
      panelHeading: '.col-md-12 .panel .panel-heading.domain-selection',
  ...
  /**
   * ### EdgeCacheForm.getPanelHeadingElem()
   *
  ...
  /**
   * ### EdgeCacheForm.getPullRightElem()
   *
  ...
  /**
   * ### EdgeCacheForm.getUpdateReportsBtn()
   *
  ...
  /**
   * ### EdgeCacheForm.getSearchDomainTxtIn()
   *
  ...
  /**
   * ### EdgeCacheForm.clickUpdateReports()
   *
