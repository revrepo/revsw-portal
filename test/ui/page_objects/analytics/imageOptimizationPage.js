...
var ImageOptimizationForm = require('./imageOptimizationForm');
...
var ImageOptimization = {
  ...
  form: ImageOptimizationForm,

  /**
   * ### ImageOptimization.getReportsObj()
   *
  ...
  /**
   * ### ImageOptimization.getChartsTableObj()
   *
  ...
  /**
   * ### ImageOptimization.getSelectDomainDDown()
   *
  ...
  /**
   * ### ImageOptimization.getSelectSearchInput()
   *
  ...
  /**
   * ### ImageOptimization.clickSelectDomain()
   *
  ...
  /**
   * ### ImageOptimization.clickSelectSearchDomain()
   *
  ...
  /**
   * ### ImageOptimization.setSelectSearchDomain()
   *
  ...
  /**
   * ### ImageOptimization.getChartTitle()
   *
  ...
  /**
   * ### ImageOptimization.getSelectedDomain()
   *
  ...
  /**
   * ### ImageOptimization.selectDomain()
   *
  ...
  /**
   * ### ImageOptimization.createBandwidthUsageReport()
   *
  ...
  /**
   * ### ImageOptimization.createTotalRequestsReport()
   *
  ...
  /**
   * ### ImageOptimization.createHttpHttpsHitsReport()
   *
  ...
  /**
   * ### ImageOptimization.createHttpStatusCodeHitsReport()
   *
  ...
  /**
   * ### ImageOptimization.createRequestStatusReport()
   *
  ...
  /**
   * ### ImageOptimization.createEdgeCacheEfficiencyHitsReport()
   *
  ...
  /**
   * ### ImageOptimization.getBandwidthUsageValues()
   *
  ...
  /**
   * ### ImageOptimization.getTotalRequestsValues()
   *
  ...
  /**
   * ### ImageOptimization.getHttpHttpsHitsValues()
   *
  ...
  /**
   * ### ImageOptimization.getHttpStatusCodeHitsValues()
   *
  ...
  /**
   * ### ImageOptimization.getRequestStatusValues()
   *
  ...
  /**
   * ### ImageOptimization.getEdgeCacheEfficiencyHitsValues()
   *
