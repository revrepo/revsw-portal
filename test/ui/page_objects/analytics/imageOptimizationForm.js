...
var ImageOptimizationForm = {
  ...
  /**
   * ### ImageOptimization.getImageOptimizationReport()
   *
   ...
   * @returns {Promise}
   */
  getImageOptimizationReport: function (indexChart, indexForm) {
    return this
      .getChartsTableObj()
  ...
  setDelay: function (indexChart, indexForm, value) {
    return this
      .getImageOptimizationReport(indexChart, indexForm) // (0, 0)
  ...
  setCountry: function (indexChart, indexForm, value) {
    return this
      .getImageOptimizationReport(indexChart, indexForm) // (0, 1)
      .element(by.model(this.locators.models.country))
      .sendKeys(value);
  },

  /**
   * ### ImageOptimization.setOS()
   *
  ...
  setOS: function (indexChart, indexForm, value) {
    return this
      .getImageOptimizationReport(indexChart, indexForm) // (0, 2)
      .element(by.model(this.locators.models.os))
      .sendKeys(value);
  },

  /**
   * ### ImageOptimization.setDevice()
   *
  ...
  setDevice: function (indexChart, indexForm, value) {
    return this
      .getImageOptimizationReport(indexChart, indexForm) // (0, 3)
      .element(by.model(this.locators.models.device))
      .sendKeys(value);
  },

  /**
   * ### ImageOptimization.clickCreateReport()
   *
  ...
  clickCreateReport: function (indexChart, indexForm) {
    return this
      .getImageOptimizationReport(indexChart, indexForm) // (0, 4)
      .click();
  },

  /**
   * ### ImageOptimization.getDelay()
   *
  ...
  getDelay: function (indexChart, indexForm) {
    return this
      .getImageOptimizationReport(indexChart, indexForm)
      .element(by.model(this.locators.models.delay))
      .getAttribute('value');
  },

  /**
   * ### ImageOptimization.getCountry()
   *
...
module.exports = ImageOptimizationForm;
