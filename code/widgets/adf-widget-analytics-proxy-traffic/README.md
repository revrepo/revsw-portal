...
analytics-proxy-traffic widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-analytics-proxy-traffic
...
```html
<script type="text/javascript" src="path/to/analytics-proxy-traffic.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.analytics-proxy-traffic']);
```
