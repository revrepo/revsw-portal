(function() {
  ...
  function TopReportsTrafficController($q, $scope, User, AlertService, Stats, Countries, Util, $timeout, $config, $sce) {
    ...
    $scope.popoverHelpHTML= {
      'mobileDesktopRatio': $sce.trustAsHtml('The pie chart reports the distribution of traffic bewteen desktop and mobile users, and also the level of ' +
        'traffic generated by web spiders (crawlers)'),
      'cacheStatus': $sce.trustAsHtml('The graph reports the level of TODO text for help'),
