(function() {
  ...
  angular
    ...
    .directive('hitsSecondaryCacheChart', hitsSecondaryCacheChartDirective);

  /*@ngInject*/
  function hitsSecondaryCacheChartDirective() {
    ...
    return {
      ...
      controller: function($scope, Stats, $q, Util, filterGeneratorService, EventsSerieDataService, $sce, $config) {
        ...
        $scope.popoverHelpHTML = $sce.trustAsHtml('For domains with secondary cache storage (like domains with enabled Image Optimization ' +
        ...
        $scope.reload = function() {
          ...
          $q.all([
            ...
            Stats.secondaryCacheTraffic(angular.merge({
