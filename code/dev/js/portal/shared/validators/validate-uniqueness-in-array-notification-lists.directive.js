(function (angular) {
  ...
  angular
    ...
    .directive('validateUniquenessInArrayNotificationLists', validateUniquenessInArrayNotificationLists);

  function validateUniquenessInArrayNotificationLists() {
    var _name = 'uniqueness-in-array-notification-lists';
    ...
    return {
      require: 'ngModel',
      scope: {
        arrayOfCheck: '=validateUniquenessInArrayNotificationLists',
      },
      link: link
    };
  }
